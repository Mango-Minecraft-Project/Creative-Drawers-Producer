onEvent("recipes", (event) => {
  ...
  event.custom({
    ...
    output: { pigment: "mekanism:purple", amount: 100 },
  });

  event.custom({
    type: "mekanism:pigment_extracting",
    input: { ingredient: { item: "mekanism:enriched_refined_obsidian" } },
  ...
  event.custom({
    ...
    output: { pigment: "mekanism:blue", amount: 100 },
  });

  event.custom({
    type: "mekanism:pigment_extracting",
    input: { ingredient: { item: "mekanism:enriched_diamond" } },
  ...
  event.custom({
    ...
    output: { pigment: "mekanism:red", amount: 100 },
  });

  event.custom({
    type: "mekanism:pigment_extracting",
    input: { ingredient: { item: "mekanism:enriched_redstone" } },
  ...
  event.custom({
    ...
    output: { pigment: "mekanism:green", amount: 100 },
  });

  event.custom({
    type: "mekanism:pigment_extracting",
    input: { ingredient: { item: "kubejs:enriched_uranium" } },
  ...
  event.custom({
    ...
    output: { item: "kubejs:uncolored_alloy_infused" },
  });

  event.custom({
    type: "mekanism:metallurgic_infusing",
    itemInput: { ingredient: { item: "mekanism:ingot_osmium" } },
    chemicalInput: { amount: 20, tag: "mekanism:tin" },
  ...
  event.custom({
    ...
    itemInput: {
      ingredient: {
        ...
        base: { item: "kubejs:uncolored_alloy_infused" },
        subtracted: { item: "mekanism:alloy_infused" },
      },
    },
    chemicalInput: { amount: 100, pigment: "mekanism:red" },
  ...
  event.custom({
    ...
    itemInput: {
      ingredient: {
        type: "forge:difference",
        base: { item: "kubejs:uncolored_alloy_infused" },
        subtracted: { item: "mekanism:alloy_reinforced" },
      },
    },
    chemicalInput: { amount: 200, pigment: "mekanism:blue" },
  ...
  event.custom({
    ...
    itemInput: {
      ingredient: {
        type: "forge:difference",
        base: { item: "kubejs:uncolored_alloy_infused" },
        subtracted: { item: "mekanism:alloy_atomic" },
      },
    },
    chemicalInput: { amount: 400, pigment: "mekanism:purple" },
  ...
  event.custom({
    ...
    itemInput: {
      ingredient: {
        type: "forge:difference",
        base: { item: "kubejs:uncolored_control_circuit" },
        subtracted: { item: "mekanism:basic_control_circuit" },
      },
    },
    chemicalInput: { amount: 200, pigment: "mekanism:green" },
  ...
  event.custom({
    ...
    itemInput: {
      ingredient: {
        type: "forge:difference",
        base: { item: "kubejs:uncolored_control_circuit" },
        subtracted: { item: "mekanism:advanced_control_circuit" },
      },
    },
    chemicalInput: { amount: 400, pigment: "mekanism:red" },
  ...
  event.custom({
    ...
    itemInput: {
      ingredient: {
        type: "forge:difference",
        base: { item: "kubejs:uncolored_control_circuit" },
        subtracted: { item: "mekanism:elite_control_circuit" },
      },
    },
    chemicalInput: { amount: 600, pigment: "mekanism:blue" },
  ...
  event.custom({
    ...
    itemInput: {
      ingredient: {
        type: "forge:difference",
        base: { item: "kubejs:uncolored_control_circuit" },
        subtracted: { item: "mekanism:ultimate_control_circuit" },
      },
    },
    chemicalInput: { amount: 800, pigment: "mekanism:purple" },
  ...
  event.custom({
    ...
    input: { ingredient: { item: "immersiveengineering:ingot_uranium" } },
    output: { item: "kubejs:enriched_uranium" },
  });

  event.custom({
    type: "mekanism:enriching",
    input: { ingredient: { item: "powah:uraninite" } },
  ...
  event.custom({
    ...
    duration: 1000,
    itemOutput: { item: "custom:pllet_machine" },
    gasOutput: { gas: "mekanism:spent_nuclear_waste", amount: 100 },
  });
});
