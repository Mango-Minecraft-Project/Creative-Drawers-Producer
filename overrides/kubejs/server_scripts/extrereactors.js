onEvent("recipes", (event) => {
  event.shapeless("2x kubejs:black_mix_ingot", [
    "minecraft:coal",
    "kubejs:mix_ingot",
  ]);
  ...
  event.shaped("bigreactors:basic_reactorcasing", ["SWS", "WAW", "SWS"], {
    S: "kubejs:mix_ingot",
    W: "bigreactors:graphite_ingot",
    A: "thermal:machine_frame",
  });

  event.shaped("bigreactors:basic_turbinecasing", ["SWS", "WAW", "SWS"], {
    S: "kubejs:mix_ingot",
    W: "bigreactors:cyanite_ingot",
    A: "thermal:machine_frame",
  });

  event.shaped("bigreactors:reinforced_reactorcasing", ["SWS", "WAW", "SWS"], {
    S: "immersiveengineering:ingot_steel",
    W: "bigreactors:graphite_ingot",
    A: "thermal:machine_frame",
  });

  event.shaped("bigreactors:reinforced_turbinecasing", ["SWS", "WAW", "SWS"], {
    S: "immersiveengineering:ingot_steel",
    W: "bigreactors:cyanite_ingot",
    A: "thermal:machine_frame",
  });
