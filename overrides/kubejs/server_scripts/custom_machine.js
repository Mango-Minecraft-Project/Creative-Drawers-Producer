onEvent("recipes", (event) => {
  ...
  event.recipes.custommachinery
    ...
    .requireStructure(
      ...
      ],
      {
        a: "create:depot",
        b: "create:deployer",
        c: "extrautilitiesrebirth:quadruple_compressed_cobblestone",
      }
    );
  ...
  event.recipes.custommachinery
    ...
    .requireStructure(
      ...
      ],
      {
        a: "create:depot",
        b: "create:deployer",
        c: "extrautilitiesrebirth:double_compressed_dirt",
      }
    );
  ...
  event.recipes.custommachinery
    ...
    .requireStructure(
      ...
      ],
      {
        a: "create:depot",
        b: "create:deployer",
        c: "extrautilitiesrebirth:double_compressed_sand",
      }
    );
  ...
  event.recipes.custommachinery
    ...
    .requireStructure(
      ...
      ],
      {
        ...
        b: "modularrouters:modular_router",
      }
    );
  ...
  event.recipes.custommachinery
    ...
    .requireStructure(
      ...
      {
        a: "pneumaticcraft:reinforced_brick_slab",
        b: "minecraft:netherite_block",
        c: "integrateddynamics:crystalized_chorus_block",
        d: "integrateddynamics:crystalized_chorus_block_stairs",
        e: "bloodmagic:blankrune",
        f: "bloodmagic:bettercapacityrune",
        g: "minecraft:beacon",
        h: "bloodmagic:altar",
      }
    );
  ...
  event.recipes.custommachinery
    ...
    .requireStructure(
      [
        ["  A  ", " AAA ", "AAAAA", " AAA ", "  A  "],
        [" AAA ", "ABBBA", "ABBBA", "ABBBA", " AAA "],
        ["AAAAA", "A   A", "A D A", "A   A", "AACAA"],
        [" AAA ", "ABBBA", "ABBBA", "ABBBA", " AAA "],
        ["  A  ", " AAA ", "AAmAA", " AAA ", "  A  "],
      ],
      {
