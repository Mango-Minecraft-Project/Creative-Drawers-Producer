onEvent("recipes", (event) => {
  ...
  event.custom({
    ...
    input: { item: "kubejs:nether_end" },
    output: { item: "kubejs:machine_core" },
  ...
  event.custom({
    ...
    output: { item: "custom:netherrack_machine" },
    time: 250,
  });
  ...
  event.custom({
    ...
    sapling: { item: "minecraft:oak_sapling" },
    output: { item: "custom:endstone_machine" },
    time: 250,
  });
  ...
  event.custom({
    ...
    sapling: { item: "minecraft:oak_sapling" },
    output: { item: "mob_grinding_utils:golden_egg" },
    time: 250,
  });
  ...
  event.custom({
    ...
    sapling: { item: "minecraft:oak_sapling" },
    output: { item: "custom:snow_machine" },
    time: 250,
  });
});
