onEvent("recipes", (event) => {
  ...
  event.shaped("custom:void_oil_machine", ["SBS", "QWA", "SBS"], {
  ...
  event.shaped("custom:blood_generate", ["SBS", "AWA", "SBS"], {
    S: "bloodmagic:blankrune",
  ...
  event.shaped("custom:fissile_machine", ["SBS", "BWB", "SBS"], {
    S: "mekanism:sps_port",
    B: "mekanism:sps_casing",
    W: Item.of("extendedcrafting:singularity", {
