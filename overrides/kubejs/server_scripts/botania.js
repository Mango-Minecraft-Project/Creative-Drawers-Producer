onEvent('recipes', event => {
    ...
    event.recipes.botania.mana_infusion('24x powah:dielectric_paste', 'kubejs:mix_ingot', 200)

    event.recipes.botania.mana_infusion('240x powah:dielectric_paste', 'kubejs:mix_block', 2000)
